    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-orange-50 to-white">
      ...
      <main className="flex-1 px-4 pb-24">
        ...
        <section className="mb-8">
          ...
          <Link to="/trivia/today" className="block">
      ...
      <nav className="fixed bottom-0 left-0 right-0 border-t border-border bg-background">
        <div className="flex items-center justify-around py-3">
          <Link to="/" className="flex flex-col items-center gap-1 text-foreground">
            <Home className="h-6 w-6" />
            <span className="text-xs">ホーム</span>
          </Link>
          <Link to="/progress" className="flex flex-col items-center gap-1 text-muted-foreground">
